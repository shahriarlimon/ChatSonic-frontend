        ...
        <div class="flex h-screen w-screen items-center overflow-hidden px-2">
            <div class="relative flex w-96 flex-col space-y-5 rounded-lg border bg-white px-5 py-10 shadow-xl sm:mx-auto">
                ...
                <div class="mx-auto mb-2 space-y-3">
                    <h1 class="text-center text-3xl font-bold text-gray-700">Log in</h1>
                    <p class="text-gray-500">Login in to access your account</p>
                </div>
                ...
                <p class="text-center text-gray-600">
                    ...
                    <Link href="/signup" class="whitespace-nowrap font-semibold text-gray-900 hover:underline">Sign up</Link>
                </p>
            </div>
        </div>
